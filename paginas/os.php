...
<div class="row justify-content-md-center">
	<div class="col-md-6 align-self-start">
		<div class="py-5 text-center">
			...
			<h1 class="cover-heading">Cadastro de Ordens de Serviço</h1>
		</div>
		...
		<form class="needs-validation" action="<?= $target ?>" method="post" novalidate>
			<div class="row">
				<div class="col-md-6 mb-3">
					...
					<input type="text" class="form-control" id="nome" name="nome" placeholder="" value="<?= ISSET($reg) ? $reg['nome'] : ""?>" required>
				...
				<div class="col-md-6 mb-3">
					...
					<input type="text" class="form-control" id="sobrenome" name="sobrenome" placeholder="" value="<?= ISSET($reg) ? $reg['sobrenome'] : ""?>" required>
			...
			<div class="mb-3">
				...
				<input type="email" class="form-control" id="email" name="email" placeholder="" value="<?= ISSET($reg) ? $reg['email'] : ""?>">
			</div>
			...
			<div class="mb-3">
				...
				<input type="text" class="form-control" id="servico" name="servico" placeholder="" value="<?= ISSET($reg) ? $reg['servico'] : ""?>" required>
			...
			<div class="row">
				<div class="col mb-3">
					...
					<input type="date" class="form-control" id="data" name="data" placeholder="" value="<?= ISSET($reg) ? $reg['data'] : ""?>" required>
				...
				<div class="col mb-3">
					...
					<input type="time" class="form-control" id="hora" name="hora" placeholder="" value="<?= ISSET($reg) ? $reg['hora'] : ""?>" required>
				...
				<div class="col mb-3">
					...
					<input type="number" min="1" step="any" class="form-control" id="valor" name="valor" placeholder="" value="<?= ISSET($reg) ? $reg['valor'] : ""?>" required>
				...
				<div class="col mb-3">
					...
					<input type="number" min="1" step="any" class="form-control" id="tempo" name="tempo" placeholder="" value="<?= ISSET($reg) ? $reg['tempo'] : ""?>" required>
			...
			<div class="mb-3">
				...
				<textarea class="form-control" id="descricao" name="descricao" rows="3"><?= ISSET($reg) ? $reg['descricao'] : ""?></textarea>
			</div>
